...
def parse_args():
    parser = argparse.ArgumentParser(description="CNN-Based Genotype Model Training")
    parser.add_argument("-ID", type=str, default="1", help="ID of the experiment")
    parser.add_argument("-exp_dir", type=str, default='/vol/research/fmodal_mmmed/Codes/5_disease_experiments/CNN/results/5d_exp_5M_summ_stats/full_overlap_no_thresholding/', help="Directory to save experiment results")
    ...
    parser.add_argument("-kernel_sizes", type=parse_int_list, default=[7,3,1], help="Convolution Kernel Size")
    parser.add_argument("-stride", type=parse_int_list, default=[2,2,1], help="Convolution Stride")
    parser.add_argument("-conv_channels", type=parse_int_list, default=[16,32,64], help="Convolution channels")
    ...
    parser.add_argument("-resume", type=int, default=1, choices=[0, 1], 
                        help="Whether to resume from checkpoint if available (0: no, start fresh; 1: yes, resume if available)")
