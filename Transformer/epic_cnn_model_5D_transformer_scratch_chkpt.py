...
def parse_args():
    ...
    parser.add_argument("-seq_len", type=int, default=512, help="Sequence length after pooling for transformer input")
    ...
    parser.add_argument("-conv_channels", type=parse_int_list, default=[32,64,384], help="Convolution channels")
