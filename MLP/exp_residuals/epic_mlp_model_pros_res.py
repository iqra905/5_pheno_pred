...
def parse_args():
    ...
    parser.add_argument("-exp_dir", type=str, default='/vol/research/fmodal_mmmed/Codes/5_disease_experiments/MLP/exp_residuals/results/pros/full/', help="Directory to save experiment results")
    ...
    parser.add_argument("-label_col", type=str, default="pros01_res", help="Column name in phenotype file to use as label (e.g., 'pros01', etc.)")
...
class GenotypeDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Use memory-mapped file for faster r2ess
