...
def parse_args():
    ...
    parser.add_argument("-exp_dir", type=str, default='/vol/research/fmodal_mmmed/Codes/5_disease_experiments/MLP/results/col/col_0.1/chr_wise/without_covariates/', help="Directory to save experiment results")
    ...
    parser.add_argument("-chr_file", type=str, default='/vol/vssp/SF_ucdatasets/gwas/gwas_mono_rm/meta_data/first_5_columns_col_can_0.1.gen.gz', help="Path to chromosome metadata file")
...
class GenotypeDataset(Dataset):
    def __init__(self, file_list, phenotype_data, chromosome_info, label_column, use_covariates=True):
