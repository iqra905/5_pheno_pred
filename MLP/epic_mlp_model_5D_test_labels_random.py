...
def parse_args():
    ...
    parser.add_argument("-exp_dir", type=str, default='/vol/research/fmodal_mmmed/Codes/5_disease_experiments/MLP/results/pros/pros_0.1/full/random_test_labels/', help="Directory to save experiment results")
...
class GenotypeDataset(Dataset):
    def __init__(self, file_list, phenotype_data, label_column, use_covariates=True, is_test=False):
    ...
    def __getitem__(self, idx):
        ...
        return genotype_tensor, covariates_tensor, label
    ...
    def __init__(self, input_size, hidden_sizes, dropout_rate, act, use_covariates=True, num_covariates=10):
        ...
        for i in range(len(layer_sizes) - 1):
            ...
            if i < len(layer_sizes) - 2:  
                self.mlp_layers.append(nn.BatchNorm1d(layer_sizes[i+1]))
                self.mlp_layers.append(self.get_activation(act))
