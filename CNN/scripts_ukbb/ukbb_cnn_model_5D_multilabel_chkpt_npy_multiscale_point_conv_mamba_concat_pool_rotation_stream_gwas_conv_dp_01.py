...
def main():
    ...
    if args.dataloader_type == "gwas":
        from ukbb_dataloader_with_rotation_multigpu_filtered_gwas_summ_stats_stratified_01 import prepare_data_splits, create_dataloaders_with_rotation, create_dataloaders
