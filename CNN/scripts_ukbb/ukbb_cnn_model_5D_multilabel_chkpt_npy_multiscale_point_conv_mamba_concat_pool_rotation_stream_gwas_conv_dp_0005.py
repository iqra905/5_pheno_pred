...
def parse_args():
    ...
    parser.add_argument("-sch", type=str, default="exponential_decay", choices=["none","plateau", "cosine", "cosine_warmup", "step","multistep","explr","warmup_exponential", "exponential_decay"], help="Learning rate scheduler")
...
def main():
    ...
    if args.dataloader_type == "gwas":
        from ukbb_dataloader_with_rotation_multigpu_filtered_gwas_summ_stats_stratified_0005 import prepare_data_splits, create_dataloaders_with_rotation, create_dataloaders
