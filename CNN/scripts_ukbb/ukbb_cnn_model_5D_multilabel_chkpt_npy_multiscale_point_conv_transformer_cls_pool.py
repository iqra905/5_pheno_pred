...
from ukbb_dataloader import prepare_data_splits, create_dataloaders
...
def parse_args():
    ...
    parser.add_argument("-phenotype_file", type=str, default='/mnt/fast/datasets/ucdatasets/gwas/ukbb/iqra/ukb_maf0.05_bgen_Iqra/ukb_cancers_t2d_ukb676869_13102025.tsv', help="Path to phenotype file")
...
def main():
    ...
    # Prepare data splits using updated dataloader
    ...
    # Create dataloaders using updated dataloader
