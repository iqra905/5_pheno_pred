...
def parse_args():
    ...
    parser.add_argument("-epic_filtered_dataloader", type=int, default=0, choices=[0, 1], help="Use Epic SNPs filtered dataloader (0: standard, 1: filtered)")    
...
def main():
    ...
    # Conditional import - whether to use all SNPs or EPIC filtered SNPs or GWAS summ stats filtered SNPs
    if args.epic_filtered_dataloader:
