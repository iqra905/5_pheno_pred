...
def parse_args():
    ...
    parser.add_argument("-use_mamba", type=int, default=0, choices=[0, 1], help="Whether to use Mamba layers after convolution (0: no, 1: yes)")
    ...
    parser.add_argument("-dataloader_type", type=str, default="standard", 
