...
disease_colors_option5 = {
    ...
    'Colorectal Cancer': '#029E73',       # Bluish Green
...
class NatureGWASVisualizer:
    ...
    def create_figure02a_population_dataset(self):
        ...
        plt.savefig(os.path.join(self.output_dir, 'fig_02a_population_dataset.pdf'), format='pdf', bbox_inches='tight', dpi=600)
    ...
    def create_figure02b_train_set(self):
        ...
        plt.tight_layout()
        plt.subplots_adjust(left=0.01, right=0.99, top=0.85, bottom=0.25)
        plt.savefig(os.path.join(self.output_dir, 'fig_02b_train_set.pdf'), format='pdf', bbox_inches='tight', dpi=600)
    ...
    def create_radar_plot(self, data_dict, title, filename, show_covariates_label=False):
        ...
        for i, (angle, disease) in enumerate(zip(angles[:-1], diseases)):
            ...
            if title =='Method Comparison Across Diseases (With Covariates)' and disease == 'Prostate Cancer':
                print(f"min value brea {min_value}")
                min_value = min_value + 0.0172
            ...
            if disease == 'T2D' or disease == 'Colorectal Cancer':
            ...
            if disease == 'Breast Cancer':
                min_label_radius = min_label_radius - 0.05
            elif disease == 'T2D':
                ...
                if title =='Method Comparison Across Diseases (With Covariates)': 
                    min_label_radius =min_label_radius - 0.12
                else:
                    min_label_radius =min_label_radius - 0.23
...
if __name__ == "__main__":
    ...
    output_dir = '/vol/research/fmodal_mmmed/Codes/5_disease_experiments/GWAS_Results_Nature/updated_figs_max_norm/nature'
