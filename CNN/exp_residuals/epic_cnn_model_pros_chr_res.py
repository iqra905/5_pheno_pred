...
def parse_args():
    ...
    parser.add_argument("-exp_dir", type=str, default='/vol/research/fmodal_mmmed/Codes/5_disease_experiments/CNN/exp_residuals/results/pros/chr_wise/', help="Directory to save experiment results")
    ...
    parser.add_argument("-snp_file", type=str, default='/vol/vssp/SF_ucdatasets/gwas/gwas_mono_rm/meta_data/first_5_columns_pros_can_pruned.gen', help="Path to SNP information file")
...
class ChromosomeWiseGenotypeDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return genotype_dict, label_tensor
...
class ChromosomeWiseGenotypeModel(nn.Module):
    def __init__(self, chr_input_sizes, conv_channels, fc_layers, act, dropout_rate):
        ...
        print(f"ChromosomeWiseGenotypeModel initialized")
...
def main():
   ...
   # Load SNP info
    ...
    train_dataset = ChromosomeWiseGenotypeDataset(train_files, phenotype_data, snp_info, label_column=args.label_col)
    val_dataset = ChromosomeWiseGenotypeDataset(val_files, phenotype_data, snp_info, label_column=args.label_col)
    test_dataset = ChromosomeWiseGenotypeDataset(test_files, phenotype_data, snp_info, label_column=args.label_col)
