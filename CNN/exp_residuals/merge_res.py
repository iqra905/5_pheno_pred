...
def merge_summary_csv(directory):
    ...
    merged_data.to_csv('/vol/research/fmodal_mmmed/Codes/5_disease_experiments/CNN/exp_residuals/results/pros/chr_wise/results_cnn_exp_chr_wise_res.csv', index=False)

    print("Merged summary CSV file sorted and created successchr_wisey.")

directory_path = '/vol/research/fmodal_mmmed/Codes/5_disease_experiments/CNN/exp_residuals/results/pros/chr_wise'
