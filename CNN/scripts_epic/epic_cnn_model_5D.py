...
def parse_args():
    ...
    parser.add_argument("-exp_dir", type=str, default='/vol/research/fmodal_mmmed/Codes/5_disease_experiments/CNN/results/pros/pros_0.01/full/', help="Directory to save experiment results")
...
class GenotypeDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Only get covariates if use_covariates is True
...
def main():
    ...
    train_dataset = GenotypeDataset(train_files, phenotype_data, label_column=args.label_col,use_covariates=bool(args.cov))
    val_dataset = GenotypeDataset(val_files, phenotype_data, label_column=args.label_col, use_covariates=bool(args.cov))
    test_dataset = GenotypeDataset(test_files, phenotype_data, label_column=args.label_col,use_covariates=bool(args.cov))
