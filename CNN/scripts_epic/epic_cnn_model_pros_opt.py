...
def parse_args():
    ...
    parser.add_argument("-ID", type=str, default="exp_work_4_40_epochs", help="ID of the experiment")
    parser.add_argument("-exp_dir", type=str, default='/vol/research/fmodal_mmmed/Codes/5_disease_experiments/CNN/results/pros/workers_4_epochs_40_prefetch/', help="Directory to save experiment results")
    ...
    parser.add_argument("-kernel_sizes", type=parse_int_list, default=[4096,1], help="Convolution Kernel Size")
    parser.add_argument("-stride", type=parse_int_list, default=[2048,1], help="Convolution Stride")
    parser.add_argument("-conv_channels", type=parse_int_list, default=[128,256], help="Convolution channels")
