...
def parse_args():
    ...
    parser.add_argument("-chunked_num_chunks", type=int, default=256, help="Number of chunks for chunked pooling strategy")
    ...
    parser.add_argument("-conv_target_length", type=int, default=128, help="Target sequence length after convolutional pooling")
...
class ConvolutionalPooling(nn.Module):
    ...
    def __init__(self, d_model, target_length=128, conv_layers=3):
        ...
        for i in range(conv_layers):
            layers.extend([
                nn.Conv1d(current_dim, current_dim, kernel_size=3, stride=2, padding=1),
