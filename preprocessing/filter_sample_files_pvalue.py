...
def main():
    base_path = '/vol/research/ucdatasets/gwas/gwas_mono_rm/stat_test_exp_split/pros/stat_res_splits_random_reverse'
    ...
    for split_folder in split_folders:
        ...
        # Input paths
        col_dir = '/vol/research/ucdatasets/gwas/gwas_mono_rm/stat_test_exp_split/pros/geno_ml'
        csv_file = os.path.join(split_folder, 'all_snps_chr_merged_0.05.csv')
        first_5_col_file = '/vol/research/ucdatasets/gwas/gwas_mono_rm/meta_data/first_5_columns_pros_can.gen.gz'
        
        # Output paths
        updated_col_dir = f'/vol/research/ucdatasets/gwas/gwas_mono_rm/stat_test_exp_split/pros/geno_ml_filtered_splits_random_reverse/{split_name}'
        ...
        output_file = f"/vol/research/ucdatasets/gwas/gwas_mono_rm/stat_test_exp_split/pros/geno_ml_filtered_splits_random_reverse/first_5_columns_pros_stat_exp_{split_name}_0.05.gen.gz"
...
#     csv_file = '/vol/research/ucdatasets/gwas/gwas_mono_rm/stat_test_exp_split/pros/stat_res_splits/split_96/all_snps_chr_merged_0.05.csv'
    
#     # First 5 columns file
#     first_5_col_file = '/vol/research/ucdatasets/gwas/gwas_mono_rm/meta_data/first_5_columns_pros.gen.gz'
    
#     # New directories for updated files
#     updated_col_dir = '/vol/research/ucdatasets/gwas/gwas_mono_rm/stat_test_exp_split/pros/geno_ml_filtered_splits/split_96_up'
...
#     #output_file = f"{file_name}_stat_exp_0.05.gen.gz"
#     output_file = f"/vol/research/ucdatasets/gwas/gwas_mono_rm/stat_test_exp_split/pros/geno_ml_filtered_splits/first_5_columns_pros_stat_exp_96_0.05.gen.gz"
