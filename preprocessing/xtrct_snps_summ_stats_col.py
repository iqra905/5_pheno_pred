...
def extract_significant_snps():
    # File paths
    file1_path = "/vol/research/ucdatasets/gwas/gwas_mono_rm/meta_data/first_5_columns_col_can.gen"
    file2_path = "/vol/research/ucdatasets/gwas/data_files/5D_snp_info_files/joint_wald_noUKB_MAC50_1_rsID.TBL"
    output_path = "/vol/research/ucdatasets/gwas/data_files/5D_snp_info_files/extracted//col/col_0.1.csv"
    ...
    file2_df['Pvalue'] = pd.to_numeric(file2_df['P.value'], errors='coerce')
