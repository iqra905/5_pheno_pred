...
def extract_significant_snps():
    # File paths
    file1_path = "/vol/research/ucdatasets/gwas/gwas_mono_rm/meta_data/first_5_columns_pan_can.gen"
    file2_path = "/vol/research/ucdatasets/gwas/data_files/5D_snp_info_files/model1_ukb_imp_chr1-22_panc_merged.txt"
    output_path = "/vol/research/ucdatasets/gwas/data_files/5D_snp_info_files/extracted/pan/pan_0.1.csv"
    ...
    file2_df['Pvalue'] = pd.to_numeric(file2_df['P_LINREG'], errors='coerce')
    ...
    file2_df['position'] = file2_df['BP'].astype(int)
    ...
    file2_df['Allele2_upper'] = file2_df['ALLELE0'].str.upper()
