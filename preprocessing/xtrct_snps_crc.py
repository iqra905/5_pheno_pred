...
parser.add_argument('-input_folder', type=str, default='/vol/vssp/SF_ucdatasets/gwas/gwas_mono_rm/disease_wise_sampled_data/col_can', help='Path to the folder with per disease sample_n.gen.gz files')
parser.add_argument('-output_folder', type=str, default='/vol/vssp/SF_ucdatasets/gwas/gwas_mono_rm/disease_wise_sampled_data/col_can_snps', help='Output folder')
parser.add_argument('-bim_files', type=str, default=['/vol/vssp/SF_ucdatasets/gwas/data_files/Archive/crc_122.bim'], help='Path to .bim files')
parser.add_argument('-summary_file', type=str, default='/vol/vssp/SF_ucdatasets/gwas/gwas_mono_rm/disease_wise_sampled_data/col_can_snps/processing_summary_crc.txt', help='Path for the summary output file')
