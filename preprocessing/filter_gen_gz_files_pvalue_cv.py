...
def read_snp_indices(csv_file):
   ...
   with open(csv_file, 'r') as f:
      ...
      for row in reader:
         ...
         if 'Global_SNP_index' in row:
               global_idx = int(row['Global_SNP_index'])
...
def parse_arguments():
    ...
    # Required arguments
    parser.add_argument('-geno_dir', default='/vol/research/ucdatasets/gwas/gwas_mono_rm/gen_data_5M/merged/chr_wise', help='Directory containing .gen.gz files')
    parser.add_argument('-first_5_col_file', default='/vol/research/ucdatasets/gwas/gwas_mono_rm/meta_data/first_5_columns_5M_updated_unq.gen', help='Path to the first 5 columns file')
    ...
    parser.add_argument('-threshold', default =0.05, help='Threshold value (e.g., 0.01)')
...
def main():
    ...
    csv_file = f'/vol/research/fmodal_mmmed/Codes/stat_analysis_lr/results_new_study_stratified_kfold/{disease}/all_snps_chr_merged_fold_{fold}_{threshold}.csv'

    # Construct updated geno directory
    updated_geno_dir = f'/vol/vssp/SF_ucdatasets/gwas/gwas_mono_rm/data_new_study_stratified_kfold/gen_data_5M_filtered/{disease}/fold_{fold}'
    ...
    first_5_col_output_dir = f'/vol/vssp/SF_ucdatasets/gwas/gwas_mono_rm/data_new_study_stratified_kfold/gen_data_5M_filtered/{disease}'

    # Save the output file in the updated_geno_dir
    output_file = os.path.join(first_5_col_output_dir, f"first_5_columns_gen_split_{disease}_{fold}_{threshold}.gen.gz")
