...
def extract_significant_snps():
    # File paths
    file1_path = "/vol/research/ucdatasets/gwas/gwas_mono_rm/meta_data/first_5_columns_t2d.gen"
    file2_path = "/vol/research/ucdatasets/gwas/data_files/5D_snp_info_files/Mahajan.NatGenet2018b.T2D.European.txt"
    output_path = "/vol/research/ucdatasets/gwas/data_files/5D_snp_info_files/extracted/t2d/t2d_0.05.csv"
    ...
    file2_df['position'] = file2_df['Pos'].astype(int)
    ...
    file2_df['Allele1_upper'] = file2_df['EA'].str.upper()
    file2_df['Allele2_upper'] = file2_df['NEA'].str.upper()
