...
def merge_summary_csv(directory):
    ...
    merged_data.to_csv('EPIC_experiments_results/CNN/pros/merged_results_pros.csv', index=False)
    print("Merged summary CSV file created successfully.")

directory_path = '/vol/research/fmodal_mmmed/Codes/GenNet_MLP/EPIC_experiments_results/CNN/pros'
