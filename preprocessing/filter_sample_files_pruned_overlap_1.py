...
def main():
    ...
    csv_file = '/vol/vssp/SF_ucdatasets/gwas/gwas_mono_rm/gen_data_5M_filtered_plink_files/t2d/t2d_0.1_LDpruned_maf_snps_0.15.csv'
    ...
    updated_geno_dir = '/vol/vssp/SF_ucdatasets/gwas/gwas_mono_rm/sampled_data_5M_pruned_overlap_analysis_t2d_full_80_20_maf_0.15/full_ldpruned_t2d_pval0.1_maf_0.15'
    ...
    # output_file = f"{file_name}_ldpruned_t2d_pval0.1_overlap_all_three.gen.gz"
    ...
    output_file = os.path.join(updated_geno_dir, f"first_5_columns_5M_updated_unq_full_ldpruned_t2d_pval0.1_maf_0.15.gen.gz")
