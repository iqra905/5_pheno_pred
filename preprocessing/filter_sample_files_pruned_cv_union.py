...
def main():
    ...
    csv_file = '/vol/vssp/SF_ucdatasets/gwas/gwas_mono_rm/data_new_study_stratified_kfold/gen_data_5M_filtered_plink_files/brea/brea_5fold_0.05_LDpruned_union.csv'
    ...
    updated_geno_dir = f'/vol/vssp/SF_ucdatasets/gwas/gwas_mono_rm/data_new_study_stratified_kfold/sampled_data_5M_disease_wise_pruned/brea/5fold_union'
    ...
    output_file = os.path.join(first_5_col_output_dir, f"first_5_columns_gen_split_brea_5fold_0.05_LDpruned_union.gen.gz")
