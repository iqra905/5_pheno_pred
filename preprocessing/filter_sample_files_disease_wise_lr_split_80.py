...
def parse_arguments():
    ...
    parser.add_argument('-geno_dir', default='/vol/vssp/SF_ucdatasets/gwas/gwas_mono_rm/disease_wise_sampled_data/pan_can',  help='Directory containing .gen.gz files')
    parser.add_argument('-csv_file', default='/vol/research/fmodal_mmmed/Codes/stat_analysis_lr/results_new/results_disease_wise_split_80/pan/all_snps_chr_merged_0.05.csv', help='CSV file with SNP indices')
    parser.add_argument('-first_5_col_file', default='/vol/vssp/SF_ucdatasets/gwas/gwas_mono_rm/meta_data/first_5_columns_pan_can.gen', help='First 5 columns file')
    parser.add_argument('-output_dir', default='/vol/vssp/SF_ucdatasets/gwas/gwas_mono_rm/disease_wise_sampled_data/80_lr_split_filtered_disease_wise/pan/0.05', help='Output directory for updated files')
    parser.add_argument('-first_5_col_output_dir', default='/vol/vssp/SF_ucdatasets/gwas/gwas_mono_rm/disease_wise_sampled_data/80_lr_split_filtered_disease_wise/',help='Output directory for the first 5 columns file')
    
    parser.add_argument('-disease', default='pan', help='Disease name (e.g., pan)')
    parser.add_argument('-pval', default='0.05', help='P-value threshold (default: 0.05)')
...
def main():
    ...
    output_file = os.path.join(
        ...
        f"first_5_columns_{args.disease}_split_100_lr_{args.pval}.gen.gz"
    )
