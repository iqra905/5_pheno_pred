...
parser.add_argument('-out_dict', type=str, default='/vol/research/ucdatasets/gwas/sampled_data/s3', help='Path to folder storing per sample files')
...
def main(input_folder, output_folder):
    ...
    sample_files = [f'sample_{i:05d}.gen.gz' for i in range(6001, 9001)]
